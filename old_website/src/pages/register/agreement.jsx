    ...
    render() {
        return(
          ...
          >
            ...
            <h3>本协议是您与荣耀ip相关事宜所订立的契约，
                请您仔细阅读本注册协议，您点击“同意”后，
                本协议即构成对双方有约束力的法律文件。
            </h3>
            ...
            <p>1、用户注册是指用户登录荣耀ip，按要求填写相关信息并确认同意本服务协议的过程。</p>


            <p>2、荣耀ip用户必须是具有完全民事行为能力的自然人。</p>


            <p>3、本产品提供试用测试，一经出售，概不退款。</p>


            <h4>第2条 用户的帐号，密码和安全性</h4>


            <p>用户一旦注册成功，成为本站的合法用户。
                荣耀ip将对用户名和密码安全负全部责任，
                若是因个人行为造成的密码用户安全问题，
                本公司不负责任。此外，每个用户都要对以其用户名进行的所有活动和事件负全责。
                用户若发现任何非法使用用户帐号或存在安全漏洞的情况，请立即通告本站或者致电官网电话。</p>

            <h4>第3条 用户依法言行义务</h4>

            <p>本协议依据国家相关法律法规规章制定，用户同意严格遵守以下义务：</p>

            <p>（1）不得传输或发表：煽动抗拒、破坏宪法和法律、行政法规实施的言论，
                煽动颠覆国家政权，推翻社会主义制度的言论，煽动分裂国家、破坏国家统一的的言论，
            ...
            <p>若用户未遵守以上规定的，本站有权作出独立判断并采取暂停或关闭用户帐号等措施。
                用户须对自己在网上的言论和行为承担法律责任。
            </p>


            <h4>第4条 协议更新及用户关注义务</h4>

            <p>根据国家法律法规变化及网站运营需要，
                荣耀ip有权对本协议条款不时地进行修改，
                修改后的协议一旦被张贴在本站上即生效，并代替原来的协议。
                用户可随时登录查阅最新协议； 
                用户有义务不时关注并阅读最新版的协议及网站公告。
                如用户不同意更新后的协议，可以且应立即停止接受网站依据本协议提供的服务；
                如用户继续使用本网站提供的服务的，即视为同意更新后的协议。
                荣耀ip建议您在使用本站之前阅读本协议及本站的公告。 
            ...
            <p>本协议的订立、执行和解释及争议的解决均应适用在中华人民共和国大陆地区适用之有效法律（但不包括其冲突法规则）。
                 ...
                 如缔约方就本协议内容或其执行发生任何争议，双方应尽力友好协商解决；协商不成时，
                 任何一方均可向有管辖权的中华人民共和国大陆地区法院提起诉讼。
            </p>
